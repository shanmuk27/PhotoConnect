...
class BookingConfirmationActivity : AppCompatActivity() {
    ...
    override fun onCreate(s: Bundle?) {
        ...
        b.tvBookingId.text   = publicBookingReference(intent.getIntExtra(EXTRA_ID, 0))
        b.tvTakerName.text   = intent.getStringExtra(EXTRA_NAME) ?: ""
        b.tvBookingDate.text = (intent.getStringExtra(EXTRA_DATE) ?: "").toDisplayDate()
        b.tvServiceType.text = (intent.getStringExtra(EXTRA_SVC) ?: "").toServiceLabel(this)
